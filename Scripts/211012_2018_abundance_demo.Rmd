...
We will plot a growth curve for each bottle. Need cell abundance data and days. 
...
ln_cells %>%
  ...
  theme_bw()
```
Exponential growth seems to be occurring right at the beginning of the experiment between 0-1 days for pretty much all the treatments. 

Let's try just plotting ln_cells to see if that helps us id exponential growth. 
